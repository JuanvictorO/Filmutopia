...
?>
<p class="titulo" id="dados">Mulher Maravilha</p>
	<div>
	<div class="align"  >
	<h3>Ficha Técnica</h3>
	Data de lançamento 1 de junho de 2017<br><br>
Direção: Patty Jenkins<br><br>
Elenco: Gal Gadot, Chris Pine, Connie Nielsen<br><br> 
Gêneros Ação, Aventura, Fantasia<br><br>
Nacionalidade EUA
	</div>
	<img src="./img/mm.jpg" class="img" class="align"/>
	</div>
...
<iframe src="https://www.youtube.com/embed/bldAkEUANWA" class="video"></iframe>
...
<div class="comentar" id="comentar">
	<h3 id="perfil" style="margin-left:  26vw"><?php if($c == false){ echo "Digite aqui seu comentário"; } else { echo "!Só é permitido um comentário do usuário por filme!";} ?></h3>
		<form method="POST" action="mm.php" style="margin-left:  26vw" style="visibility: <?php if($c == true){ echo "hidden"; } ?>">
...
<section>
	<?php
	$select = mysqli_query($conexao,'SELECT c.idFilme, c.idUsuario, c.coment,c.stars, u.nome FROM comentar c JOIN usuario u ON c.idUsuario = u.id WHERE c.idFilme =10');
